...
if ($invoiceId <= 0 || (float) $amount < 0.01 || $currency !== 'CNY' || $paymentType === '' || $token === '') {
...
if (!whmcs_peakrack_epay_verify_selection_token($gatewayParams, $invoiceId, $amount, $currency, $paymentType, $token)) {
